...
const CheckoutForm = () => {
  ...
  const verifyCashfreePayment = async (orderId: string) => {
    try {
      ...
      let res = await axios.post(`${server}/api/v1/payment/verify`, {
        orderId,
      });
  ...
  return (
    <div className="checkout-container">
      ...
      <p className="payment-disclaimer">
        Disclaimer: You will be redirected to your Orders section after
        processing the payment <br /> Please do not{" "}
        <span style={{ color: "red" }}>Leave or Refresh</span> in between{" "}
      </p>
